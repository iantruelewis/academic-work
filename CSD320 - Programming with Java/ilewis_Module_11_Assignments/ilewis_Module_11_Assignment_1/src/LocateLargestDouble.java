...
public class LocateLargestDouble {

    // Method locates largest element in a 2D double array
    public static int[] locateLargest(double[][] arrayParam) {
        // Array holds the location of the largest element (row and column)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Largest in double array: row " + location[0] + ", column " + location[1]);
    }
}
