...
/*
    This program uses JavaFX to display four images randomly selected from a deck of 52 cards.
...
public class RandomCardDisplayFX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            // Creates an ImageView for selected card
        ...
        primaryStage.setTitle("Random Card Display: JavaFX");
